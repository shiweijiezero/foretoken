...
- Prioritize user convenience across implementation, public documentation, and internal guides. Ordinary installation and common operations must work without a custom values file; reserve configuration for real overrides or external information. Derive defaults and prepare dependencies at their existing owner rather than asking users to copy settings or follow extra setup steps.
