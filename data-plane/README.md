...
| --- | --- | --- |
| [Frontend](frontend/README.md) | OpenAI and Anthropic requests, streaming responses, request admission, and runtime diagnostics | DNS, TLS, ingress policy, or desired-state reconciliation |
