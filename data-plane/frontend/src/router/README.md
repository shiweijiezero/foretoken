...
Each pipeline stage selects a lower-snake-case algorithm name. Deployments with additional compiled routing implementations can use their names in the same `routerPipeline` fields; the Frontend registry validates them at startup.
