...
Triton JIT artifacts use the Pod-local `/tmp` volume because their concurrent publication requires local rename semantics, including replacement of loaded launchers. They are reclaimed with the Pod.
