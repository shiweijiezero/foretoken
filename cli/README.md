...
Use the CLI to install the platform into the active Kubernetes context with the default local access mode. Run the same command again to update the existing installation:
