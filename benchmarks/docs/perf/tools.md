...
English | [简体中文](tools_zh.md) · [Performance examples](README.md)

After [setup](README.md#setup), send the repository's [tool request sample](../../examples/tools.jsonl) to a model service with tool-calling support:
