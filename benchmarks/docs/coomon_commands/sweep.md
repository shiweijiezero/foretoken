...
W&B shows E2EL p95 in one-second completion windows; the Pareto plot compares whole-run output tok/s per concurrency and per declared GPU. Points without either denominator are omitted.
