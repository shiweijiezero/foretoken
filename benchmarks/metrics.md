...
| Output tok/s / concurrency | Output throughput divided by a finite `--parallel` value; an auxiliary comparison metric using the configured limit, not actual active concurrency or individual request speed |
