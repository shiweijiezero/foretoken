...
该命令对 100 道 GSM8K 数学题评分，输出任务指标和样本数。[质量评测](docs/eval/README_zh.md)介绍 lm-evaluation-harness 和 EvalScope。添加 `--reference` 可[比较参考与候选模型的概率分布](docs/eval/fidelity_zh.md)。
