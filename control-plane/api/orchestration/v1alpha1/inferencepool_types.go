...
type InferencePoolSpec struct {
	...
	// foo is an example field of InferencePool. Edit inferencepool_types.go to remove/update
	// +optional
...
type InferencePoolStatus struct {
	...
	// conditions represent the current state of the InferencePool resource.
...
type InferencePool struct {
	...
	// spec defines the desired state of InferencePool
	// +required
