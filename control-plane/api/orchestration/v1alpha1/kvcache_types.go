...
type KVCacheStatus struct {
	...
	// conditions represent the current state of the KVCache resource.
...
type KVCache struct {
	...
	// spec defines the desired state of KVCache
	// +required
	Spec KVCacheSpec `json:"spec"`

	// status defines the observed state of KVCache
	// +optional
	Status KVCacheStatus `json:"status,omitzero"`
}
