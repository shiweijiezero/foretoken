...
type ModelServiceSpec struct {
	...
	// foo is an example field of ModelService. Edit modelservice_types.go to remove/update
	// +optional
...
type ModelServiceStatus struct {
	...
	// conditions represent the current state of the ModelService resource.
